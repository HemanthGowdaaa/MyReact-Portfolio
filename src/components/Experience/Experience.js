...
const Experience = () => {
    const experiences = [
        { year: 'June 2024 – Present', title: 'Data Analyst Intern', company: 'Anudip Foundation, Bengaluru, India', description: 'Utilized Power BI, SQL, and Python to conduct in-depth analysis of Netflix, Shadow Economy Funds and Tata Motors. creating impactful visualizations and insightful reports.',link:'https://anudip.org/' },
